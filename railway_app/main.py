...
# Get the correct paths - Now that entire project is copied
app_root = '/app'  # Railway copies entire project to /app
server_dir = os.path.join(app_root, 'server')  # /app/server
